...
<div class="flex flex-col h-full">
    ...
    <div class="flex flex-col h-full">
        ...
        <div :class="howOrgPoppup==true?'flex-row':'flex-col'" class="flex  ">
                ...
                <div v-if="listeFormatoin.length>0" class=" text-xs flex-row">
                    <div class="flex flex-row sticky top-10 py-4 bg-white mt-6">
                        ...
                        <div class="flex w-full justify-end relative">
                            <btn_Vue class=" " :options="{label:'Nouveau',style:' base_bg text-white w-full',ico:$store.state.icons.edit}"></btn_Vue>
                        </div>
                    </div>
            ...
            <div class=" sticky flex flex-col  mx-3 bg-white rounded-lg w-full px-5">
                <div class=" z-20 sticky top-12 mx-3 bg-white rounded-lg py-5 px-5 flex justify-between w-full">
                    ...
                    <div class="flex items-center flex-row text-sm ">
                        <span v-for="item,i in listeMenu" @click="()=>{indexFormulaire=i}" :key="i" :class="indexFormulaire==i?' bg-teal-500 text-white rounded-md':''"  class=" mx-2 py-1 px-2" v-text="item"></span> 
