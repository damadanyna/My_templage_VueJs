...
<div class="flex flex-col h-full">
    ...
    <div :class="showFormulaire==true?'flex-row':'flex-col'" class="flex w-full ">
        <div :class="showFormulaire==true?' px-5  w-[40%] ':'px-12 w-full '" class="flex-col duration-500  bg-white rounded-lg h-max  flex z-10">
            ...
            <!-- tableau -->
            <div class=" text-xs  flex w-full  mt-4">
                <table class=" w-full items-start px-1">
                    <tr class=" sticky top-20 h-9 bg-white w-full">
                        ...
                        <th v-if="showFormulaire!=true" class="   w-[16%] text-start text-stone-500 border-r border-stone-400 pl-5 ">Fonction</th>
                        <th v-if="showFormulaire!=true" class="   w-[16%] text-start text-stone-500 border-r border-stone-400 pl-5 ">PDF</th>
                    ...
                    <tr v-for="i in 20" :key="i" class=" duration-200 hover:text-white  hover:bg-[#63B6B9]  ">
                        ...
                        <td v-if="showFormulaire!=true" class="pl-5" v-text="'[Fonction]'"></td>
                        <td v-if="showFormulaire!=true" class="pl-5" v-text="'[Lien PDF]'"></td>
