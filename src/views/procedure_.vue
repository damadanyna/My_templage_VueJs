...
<div class="flex flex-col h-full">
    ...
    <div :class="showFormulaire==true?'flex-row':'flex-col'" class="flex w-full ">
        <div :class="showFormulaire==true?' px-2  w-[36%] ':'px-12 w-full '" class=" py-4 flex-col duration-500  bg-white rounded-lg h-max  flex z-10">
            ...
            <div v-if="showFormulaire!=true" class="  mt-9 flex w-full bg-white py-4 flex-row mx-1  ">
            ...
            <div class="  text_xs w-full h-[80vh] px-2 overflow-auto  mt-4">
                <table class=" w-full items-start px-1">
                    ...
                    <tr v-for="item,i in this.$store.state.myData.listeFormation"  :key="i" class=" duration-200 hover:text-white  hover:bg-[#63B6B9]  ">
