...
<div v-if="!$route.params.id " class="flex flex-row">
    <div :class="showFormulaire==true ?'w-[40%]':' w-full'" class=" text-lg sticky -top-20 flex flex-col h-full">
        <h1 class=" w-full bg-stone-100 z-50 font-bold text-stone-600  pb-6">Liste Bénéfice</h1>
        <div :class="showFormulaire==false?'px-7':'px-2'" class=" duration-500 py-5 bg-white rounded-lg  flex z-10 flex-col ">
            ...
            <div class="flex  flex-row     bg-white mt-4">
                ...
                <div class="flex w-full flex-row justify-end   ">
                    ...
                    <button v-else @click="()=>{showFormulaire=false}" class=" sticky top-4  bg-[#63B6B9] mr-3 px-2 border border-black rounded-full">
            ...
            <div class="flex w-full text_xs mt-4  h-[70vh] px-2  overflow-auto">
                <table class=" w-full items-start px-1">
                    <tr class=" w-full sticky top-0 bg-white py-5  ">
                        ...
                        <th v-if="showFormulaire==false" class=" py-2  w-[19] text-center text-stone-500 ">Actions</th>
                    </tr>
    ...
    <div v-if="showFormulaire==true  " class=" flex flex-col   rounded-lg w-[60%]  px-3">
        <div class="flex z-50  bg-stone-100 flex-row items-center">
            ...
            <h1 class=" text-lg w-full   z-50 font-bold text-stone-600 pt-2 pb-4">Bénéficiaire :</h1>
        </div>
