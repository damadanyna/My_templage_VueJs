<template>
    <div class="flex"> 
        <div @click="()=>{change_val()}" class="selectOptionOne text-[12px]" style="width:200px;">
            <select >
    ...
    export default {
        ...
        methods:{
            change_val(){
                this.$store.state.statut_= document.querySelector('.selectOptionOne').children[1].innerHTML;
            }
        },
        mounted() {
    
            var x, i, j, l, ll, selElmnt, a, b, c;
            /*look for any elements with the class "selectOptionOne":*/
            x = document.getElementsByClassName("selectOptionOne");
            l = x.length;
            for (i = 0; i < l; i++) {
