            ...
            <tr v-for="item,i in module" :key="i" class=" duration-200 hover:text-white  hover:bg-[#63B6B9]  ">
                ...
                <td class=" px-2">
                    <div class=" my-2 flex flex-row items-center py-1">
                        ...
                        <button class=" mr-2 bg-slate-100 px-1 rounded-md py-1 ">
                            <svg class=" fill-current text-[#63B6B9] rounded-md w-4" viewBox="0 0 24 24"><path d="M20.71 7.04c.39-.39.39-1.04 0-1.41l-2.34-2.34c-.37-.39-1.02-.39-1.41 0l-1.84 1.83 3.75 3.75M3 17.25V21h3.75L17.81 9.93l-3.75-3.75L3 17.25z" /></svg>
                        </button>
                    </div>
                </td>
            </tr>
