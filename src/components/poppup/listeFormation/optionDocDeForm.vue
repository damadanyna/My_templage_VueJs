...
<div class="flex flex-col">
    ...
    <div class="flex flex-row">
        <btn_ class=" " :options="{label:'Nouveau Objectif',style:' px-0 base_bg text-xs  text-white ',ico:$store.state.icons.plus}"></btn_>
        <btn_ class=" ml-2 " :options="{label:'Bibliothéque d\'objectif',style:' base_bg text-xs  text-white ',ico:$store.state.icons.list}"></btn_>
    </div>
...
<!-- 
    fire base projet 
    header tableau doit etre fixé
    buger pour fermer et flèche pour ouvrir
    quand hover ce sera bleu
 -->
